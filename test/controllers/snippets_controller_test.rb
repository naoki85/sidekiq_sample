...
class SnippetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create snippet" do
    assert_difference('Snippet.count') do
      post snippets_url, params: { snippet: { highlighted_code: @snippet.highlighted_code, language: @snippet.language, plain_code: @snippet.plain_code } }
    end
  ...
  test "should update snippet" do
    patch snippet_url(@snippet), params: { snippet: { highlighted_code: @snippet.highlighted_code, language: @snippet.language, plain_code: @snippet.plain_code } }
